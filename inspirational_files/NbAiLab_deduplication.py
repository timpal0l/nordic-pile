...
if __name__ == '__main__':
    ...
    #print(aggdict)
    print(sys.getsizeof(aggdict))

    amount_of_duplicates=0
    total_amount_paragraphs=0
    duplicate_file = open("duplicates.txt", "w")
    for l in listoffilestoinclude:
        outfilename = ""
        outfilename = outputfolder + "/" + l.split("/")[-1].strip()
        if outfilename.endswith(".jsonl") or outfilename.endswith(".json"):
            outfilename=outfilename.split(".")[0] + ".jsonl"
        else:
            outfilename = outfilename + ".jsonl"
            ...
            for line in reader:
                ...
                for pa in j['text'].split("\n"):
                    ...
                    if hsh in aggdict:
                        if aggdict[hsh][0] == jlen and aggdict[hsh][1] == 0:
                            ...
                            if aggdict[hsh][0] == jlen:
                                duplicate_file.write(patxt)
                ...
                if len(outputstring) >0:
                    ...
                    if len(outputstring) > maxlen:
                        ...
                        precision = str(round(float(conf), 3))
                        jsonObject = {"text": outputstring.strip()}
    ...
    print("Amount of paragraphs: " + str(total_amount_paragraphs))
    print("Amount of duplicates: " + str(amount_of_duplicates))
